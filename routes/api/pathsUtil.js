...
const pathsDaemons = (api) => {
  ...
  switch (os.platform()) {
    case 'darwin':
      ...
      api.komodoDir = api.appConfig && api.appConfig.general.native.dataDir.length ? api.appConfig.general.native.dataDir : `${process.env.HOME}/Library/Application Support/Komodo`,
    ...
    case 'linux':
      ...
      api.komodoDir = api.appConfig && api && api.appConfig.general.native.dataDir.length ? api.appConfig.general.native.dataDir : `${process.env.HOME}/.komodo`,
    ...
    case 'win32':
      ...
      api.komodoDir = api.appConfig && api && api.appConfig.general.native.dataDir.length ? api.appConfig.general.native.dataDir : `${process.env.APPDATA}/Komodo`,
